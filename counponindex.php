...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
    ...
    <a href="coupons.php" style="margin-top:10px; margin-bottom:10px;" class="btn btn-primary">ADD +</a>
    <table width="70%"  class="table table-bordered table-striped table-hover js-dataTable-full-pagination">
        ...
        <tbody align="center">
            ...
            <tr>
                ...
                <td style="display:flex;"> <a href="couponupdate.php/?id='<?php echo $record['id']?>'">
                        <button type="button" class="btn btn-xs btn-info push-10-r"><i class="fa fa-edit"></i>
                            Edit</button>
                    </a>
                    <form action="counponindex.php" method="POST"> 
