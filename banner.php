...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
    ...
    <a href="bannercreate.php" style="margin-top:10px; margin-bottom:10px;" class="btn btn-primary">ADD +</a>
    <table width="70%"  class="table table-bordered table-striped table-hover js-dataTable-full-pagination">
        ...
        <tbody align="center">
            ...
            <tr>
                ...
                <td style="display:flex;"> <a href="banneredit.php/?id='<?php echo $record['id']?>'">
