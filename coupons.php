...
if($_POST['submit']){
    ...
    ///var_dump($con);
    $query="INSERT INTO coupons (title,present,start,end) VALUES ('".$title."','".$present."','".$start."','".$end."')";
    //var_dump($query);
...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
    ...
    <?php require_once('includes/header.php'); ?>
	    ...
	    <form class="form-horizontal push-10-t form-notify" action="coupons.php" method="post" autocomplete="off"
        ...
        <div class="col-sm-12">
            <div     class="block">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<div class="form-material form-material-primary">
								<input id="present" name="present" type="number" value="0" min="0" required class="form-control" data-always-show="true" />
				...
				<div class="form-group">
					<div class="col-sm-12">
						<div class="form-material form-material-primary">
								<input id="start date" name="start" type="date"  required class="form-control" data-always-show="true" />
				...
				<div class="form-group">
					<div class="col-sm-12">
						<div class="form-material form-material-primary">
								<input id="end date" name="end" type="date"  required class="form-control" data-always-show="true" />
