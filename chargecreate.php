...
if ($_POST['submit']) {
	...
	///var_dump($con);
	$query = "INSERT INTO charge (title,present, charge_area_id) VALUES ('" . $title . "','" . $present . "','" . $area . "')";
	//var_dump($query);
...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
	...
	<form class="form-horizontal push-10-t form-notify" action="chargecreate.php" method="post" autocomplete="off" enctype="multipart/form-data">
		<div class="col-sm-12">
			<div class="block">
					...
					<div class="block-content tab-content">
						<div class="tab-pane active" id="btabs-alt-static-basic">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="form-material form-material-primary">
										<input id="present" name="present" type="number" value="0" min="0" max="100" required class="form-control" data-always-show="true" />
